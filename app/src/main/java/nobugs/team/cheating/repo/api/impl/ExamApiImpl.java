 ...
 */
public class ExamApiImpl implements LoginApi{

    @Override
    public void login(final String imei, final String authCode, final Callback callback) {
        Call<RespToken> call = RestClient.getApiService().login(imei, authCode);
